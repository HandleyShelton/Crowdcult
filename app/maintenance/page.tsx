  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="font-display text-4xl tracking-wider text-white mb-3">TEMPORARILY UNAVAILABLE</h1>
        ...
        <p className="font-mono text-xs text-gray-600 mt-4">
          Questions?{' '}
          <a href="mailto:hello@crowdcult.com" className="text-accent hover:text-white transition-colors">
            hello@crowdcult.com
          </a>
        </p>
      </div>
